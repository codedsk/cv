...
\makeheadingqr[]{Derrick Kearney}{qrcodecv.pdf}
...
\emph{WWW:} \url{https://dskard.github.io}\\
\emph{GitHub:} \url{https://github.com/dskard}}
...
\section{Interests}
    ...
    technologies to create software that impacts desktop, mobile, and multicore
    platforms at the operating system and ecosystem levels, while evangelizing
    about the benefits of testing, automation, and open source technologies.
...
\begin{outerlist}
    ...
    \item[] \HUBZEROPLATFORMSCICOL \\
        ...
        \begin{innerlist}
            ...
            \item \textbf{Created \href{https://github.com/dskard/hubcheck}{HUBcheck},
                ...
                \url{https://github.com/dskard/hubcheck}
...
%       Jupyter Notebooks, Submit, MATLAB, gcc, gdb, and good software practices,
%       about 30 people
...
%       https://github.com/MozillaFoundation/mozfest-program-2016/issues/820
%       https://github.com/hubzero/presentations
%       https://hubzero.github.io/presentations/....
%       30 minute fireside chat where we talked about what tools people use
%       and don't use to share their simulation tools and data with others.
...
%       http://bit.ly/mozfest415
%       https://github.com/MozillaFoundation/mozfest-program-2016/issues/415
%       https://github.com/hubzero/presentations
%       https://hubzero.github.io/presentations/....
%       2 hour workshop showing how to build and publish a Rappture and
%       Jupyter based simulation tools and notebooks on the HUBzero platform.
%       2 hours, 10 people
...
%       name not listed under speakers, but sessions are shown on Tuesday
%       1:30pm-4:30pm  https://nanohub.org/groups/conference/program

    \item Kearney, D. Software Bootcamp. \emph{NCN Software Bootcamp 2015},
        West Lafayette, Indiana, June 1--3, 2015.
        \url{https://nanohub.org/courses/tools/bootcamp2015}
%       3 day workshop introducing surf students to nanoHUB, Rappture Toolkit
