...
\begin{document}
\thispagestyle{plain}
%\makeheading[anbochedsk@gmail.com | github.com/codedsk]{Derrick Kearney}
\makeheading[]{Derrick Kearney}
...
\emph{GitHub:} \href{https://github.com/codedsk}{https://github.com/codedsk}\\
\emph{Phone:} +1 765 532 6817}

\end{tabular}


\section{Interests}
% add something about wanting to learn new technologies

    Experienced in community oriented, open source, Linux based, scientific
    software library and toolkit development. Interested in building software
    that impacts mobile and multicore platforms at the operating system and
    ecosystem levels, while evangelizing about the benefits of testing,
    automation, and open source technologies.
...
% 5. help others in the community.
        ...
        \textit{Software Engineer},
                ...
                \hfill February 2005 - Present \\
                Developer and a primary simulation tools contact for the
                \HUBZEROPLATFORM, \url{https://hubzero.org}, an open source
...
% 4. open source
% 5. help community
            \item Engaged users and open source community members to help
...
%                \RAPPTURE, an open
%                source software library designed to help scientists rapidly
%                assemble and deploy graphical user interfaces for their
%                simulation codes. Contributed to several of the core Tcl/Tk
%                widgets and built language bindings for C, \CC, FORTRAN,
%                \Matlab, Octave, Perl, Python, and R. \\

             \item Designed several core Tcl/Tk widgets for the \RAPPTURE, an
                open source software library designed to help scientists rapidly
                assemble and deploy graphical user interfaces for their simulation
                codes. Built language bindings for C, \CC, FORTRAN, \Matlab,
...
% 3. distributed teams
% 5. help community
%            \item Collaborated with dozens of research groups to build scientific
%                application that are freely available for people around the world
%                to use and learn from. 
%            \item Collaborated to build freely available, scientific applications
%                with dozens of research groups affiliated with the
            \item Collaborated with dozens of research groups affiliated with the
                    ...
                    \item[] SolarPV
                        \begin{innerlist}
                            \item[] Simulates electricity demand in residential
                              ...
                              the original proprietary model to run on the HUBzero
                              Platform, in an environment where students could
                              easily create and upload their own data profiles
...
% 4. open source code
            \item Created \href{https://github.com/codedsk/hubcheck}{HUBcheck},
                an open source Python library used to build automation scripts
                and user level tests for HUBzero based websites and workspace
                ...
                and a bunch of X server utilities. With HUBcheck, developers can
...
% 1. help drive adoption
% 5. help community
            \item Mentored students participating in the Summer
                Undergraduate Research Fellowship (SURF) program. Worked
                with other faculty, staff and graduate mentors to introduce
                students to nanotechnology research, software development
                best practices, the HUBzero Platform, and Rappture Toolkit.\\
...
%    \begin{innerlist}
%
%        \item Collaborated on the development of scientific applications for
%            research groups affiliated with the \NCN\space including
%            \href{http://dx.doi.org/10.4231/D3BV79W4T}{SolarPV} for
%            simulating solar photovoltaic systems,
%            \href{http://dx.doi.org/10.4231/D35D8NF30}{ParticleVE} for
%            estimating particle velocities using video from the 2010 Deepwater
%            Horizon oil spill, and
%            \href{http://dx.doi.org/10254/nanohub-r1090.5}{NanoFET} for
%            performing parallelized simulations of ballistic transport in
%            2D MOSFET devices.
%
%    \end{innerlist}
...
\section{Publications, Proceedings, Talks}
    ...
    \begin{innerlist}
        \item Co-authored 8 refereed journal publications and conference
...
%\section{Skills}
%%
%    C, \CC, FORTRAN, Perl, Python, \TCLTK, UNIX shell,
%    GNU Tools (Autotools, configure, Make, gdb, compilers and friends),
%    Valgrind, SQL, HTML, \Matlab, GNU Octave, R,
%    Git, \SVN, Debian GNU/Linux, IRC, SSH, Eagle Scout.
