...
\begin{document}
\thispagestyle{plain}
\makeheading[\emph{}]{Derrick Kearney}
...
\emph{GitHub:} \href{https://github.com/codedsk}{github.com/codedsk}}
...
\section{Professional Experience}
    ...
    \begin{outerlist}
        ...
        \item[] \textit{Software Engineer},
                ...
                Developer for \HUBZEROPLATFORM

        \item[] \textit{Associate Programmer},
                \href{http://www.convergys.com/}{Convergys Corporation} %
                \hfill January 2004 - January 2005 \\
...
\section{Technical Experience}
    ...
    \begin{innerlist}
        ...
        \item Contributed to several \TCLTK\space widgets and developed
            C, \CC, FORTRAN, \\
            \Matlab, Octave, Perl, Python, and R
            language bindings for the \RAPPTURE.

        \item Created \href{https://github.com/codedsk/hubcheck}{HUBcheck},
            a Python based user level test automation library for \HUBZERO \\
            based websites.

        \item Built \href{https://mygeohub.org/groups/gabbs}{geospacial
            analysis and mapping tools}, for the \RAPPTURE\space and \HUBZERO \\
            Platform, that allow scientists to display, and end users
            to manipulate, large data sets through interactive maps.
...
\section{Publications, Proceedings, Talks}
    ...
    \begin{innerlist}
        ...
        \item Led 5 \href{https://nanohub.org/courses/tools/hubbub2015}
          ...
          people software best practices and how to build and deploy
          scientific simulation software on the \HUBZERO\space Platform.
    \end{innerlist}
...
\section{Service}
    ...
    \begin{innerlist}
        ...
        \item 2012-15,
          ...
          Volunteer Chef
        \item 2012-13,
          Boy Scout Troop 336, West Lafayette, Indiana,
          Committee Chair
        \item 2005-08,
